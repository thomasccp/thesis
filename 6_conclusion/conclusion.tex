...
Such an extended model will increase the computation requirement, therefore a faster reconfigurable system is necessary.
...
The \glspl{cpu} and \glspl{fpga} partition interface via an \gls{amba} which supports high performance and low power on-chip communication.
