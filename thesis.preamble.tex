...
\newcolumntype{y}[1]{>{\columncolor{Gray}\centering\let\newline\\\arraybackslash\hspace{0pt}}p{#1}}
\usepackage{verbatim}
\usepackage{latexsym}
...
\lstnewenvironment{code}[1][]%
  {\minipage{\linewidth} 
   \lstset{basicstyle=\ttfamily\scriptsize,tabsize=2frame=single,#1}}
  {\endminipage}
...
\newacronym{dcl}{DCL}{Domain customisable Language}
\newacronym{dfs}{DFS}{Dynamic Frequency Scaling}
\newacronym{dram}{DRAM}{Dynamic Random-Access Memory}
\newacronym{dsl}{DSL}{Digital Specific Language}
...
\newacronym{hrs}{HRS}{Heterogeneous Reconfigurable System}
\newacronym{hpc}{HPC}{High-Performance Computing}
%\newacronym{isr}{ISR}{Improved Systematic Resampling}
\newacronym{lut}{LUT}{Look-Up Table}
\newacronym{pf}{PF}{Particle Filter}
\newacronym{pq}{PQ}{Proximity Query}
\newacronym{ram}{RAM}{Random-Access Memory}
\newacronym{rmse}{RMSE}{Root-Mean-Square Error}
\newacronym{rtos}{RTOS}{Real-time Operating System}
%\newacronym{rsr}{RSR}{Residual Systematic Resampling}
