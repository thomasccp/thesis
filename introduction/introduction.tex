...
\begin{itemize}
\item Precision optimisation: \todo[inline]{More description.}
\item Run-time reconfiguration: \todo[inline]{More description.}
\item Design productivity: \todo[inline]{More description.} 
\end{itemize}
